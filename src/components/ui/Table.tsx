...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full min-w-0 overflow-x-auto rounded-2xl border border-border"
    >
      <table
        data-slot="table"
        className={cn(
...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("bg-muted/40 [&_tr]:hover:bg-transparent", className)}
      {...props}
    />
  )
}
...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-muted/40 font-medium [&_td]:border-t [&_td]:border-b-0 [&_tr]:hover:bg-transparent",
        className
      )}
      {...props}
    />
...
function TableCaption({ className, ...props }: React.ComponentProps<"caption">) {
  return (
    <caption
      ...
      className={cn(
        "border-b border-border px-5 py-3 text-left text-xs text-muted-foreground",
        className
      )}
      {...props}
    />
